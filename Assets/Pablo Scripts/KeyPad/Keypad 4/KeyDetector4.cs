...
public class KeyDetector4 : MonoBehaviour
{
    ...
    void Start()
    {
        display = GameObject.FindGameObjectWithTag("Display4").GetComponentInChildren<TextMeshPro>();
        display.text = "";

        keyPadControll = GameObject.FindGameObjectWithTag("Keypad4").GetComponent<KeyPadControll>();
    }

    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("KeypadButton4"))
        {
