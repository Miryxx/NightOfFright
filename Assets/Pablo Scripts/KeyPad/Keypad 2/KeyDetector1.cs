...
public class KeyDetector1 : MonoBehaviour
{
    ...
    void Start()
    {
        display = GameObject.FindGameObjectWithTag("Display2").GetComponentInChildren<TextMeshPro>();
        display.text = "";

        keyPadControll = GameObject.FindGameObjectWithTag("Keypad2").GetComponent<KeyPadControll>();
    }

    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("KeypadButton2"))
        {
